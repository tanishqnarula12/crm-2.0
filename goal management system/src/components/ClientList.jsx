...
export default function ClientList({ clients, onSelect, onSelectFreshly, onAdd, onDelete, onImport, isViewer }) {
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-200/50 dark:divide-slate-800/50">
              {filtered.map(c => (
                <tr
                  key={c.id}
                  className="hover:bg-blue-50/20 dark:hover:bg-slate-800/40 cursor-pointer transition-colors"
